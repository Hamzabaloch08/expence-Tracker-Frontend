...
import { signUpThunk } from "../../redux/authThunks/authThunks";
import { clearError, clearMessage } from "../../redux/authSlice/authSlice";
        ...
        >
            ...
            >
                ...
                <View className="px-8">
                    ...
                    <View className="flex-row items-center bg-gray-100 rounded-2xl px-4 mb-8">
